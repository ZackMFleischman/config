...
set shortmess=aoO
badd +561 ~/.vimrc
badd +905 order/tests/test_cart_conversion.py
badd +374 helpdesk/models.py
badd +593 common/enumerated_types.py
badd +141 helpdesk/tasks.py
badd +689 my/utils/fake.py
badd +205 helpdesk/validators.py
badd +1 order/process_cart.py
badd +1 common/state.py
silent! argdel *
edit order/tests/test_cart_conversion.py
...
let s:l = 963 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
963
normal! 018l
tabedit order/process_cart.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
144
normal zo
let s:l = 1049 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1049
normal! 04l
tabedit helpdesk/validators.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
224
normal zo
let s:l = 204 - ((31 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
normal! 03l
tabedit helpdesk/tasks.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
78
normal zo
let s:l = 94 - ((32 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
normal! 0
tabedit common/enumerated_types.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
598
normal zo
let s:l = 597 - ((44 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
597
